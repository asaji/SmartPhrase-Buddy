...
function copyButtons(){return '<button id="copy-plain" class="primary">Copy plain text</button><button id="copy-rich">Copy formatted</button>';}
...
async function procedureEditor(t,draft=null){
 ...
 const e=rich('#p-content',draft?draft.content:t.content,()=>{$('#p-approved').checked=false;graded=false;updatePc();});const mine=epoch;
